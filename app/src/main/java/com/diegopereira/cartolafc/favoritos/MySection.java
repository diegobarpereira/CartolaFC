...
public class MySection extends Section {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        itemViewHolder.fav_points.setText(formatter.format(list.get(position).getPontos()));
        itemViewHolder.fav_ultima.setText(formatter.format(list.get(position).getUltima()));
        itemViewHolder.fav_cash.setText(formatter.format(list.get(position).getPatrimonio()));
